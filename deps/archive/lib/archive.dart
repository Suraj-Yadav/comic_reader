...
import 'archive_bindings_generated.dart';
...
/// The dynamic library in which the symbols for [ArchiveBindings] can be found.
  ...
  if (Platform.isWindows) {
    if (Platform.environment.containsKey('FLUTTER_TEST')) {
      return DynamicLibrary.open(
          './build/windows/runner/Release/$_libName.dll');
    }
...
final ArchiveBindings _bindings = ArchiveBindings(_dylib);
